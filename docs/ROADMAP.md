...
|--------|--------|-----------|------------|----------------|
| `core.algorithms.naive_sort` | 🔄 | 28/49 | selection, bubble, insertion | [` 📄 05_Naive_Sort.md`](core/algorithms/05_Naive_Sort.md) |
...
core.algorithms.naive_sort            🔄 28/49 (Ada, Assembly, Ballerina, C, C#, Clojure, COBOL, Common Lisp, C++, Crystal, D, Dart, Elixir, Elm, Erlang, Forth, F#, Gleam, Go, Grain, Groovy, Haskell, Haxe, Java, JavaScript, Julia, Kotlin, Lua)
