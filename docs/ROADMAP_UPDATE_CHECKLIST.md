...
- `busted` -> `●●●` y `3 successes / 0 failures / 0 errors / 0 pending : 0.000791 seconds` (exit 0; 3 tests, uno por algoritmo, con los 9 casos como aserciones dentro de cada uno = 27 comprobaciones)
