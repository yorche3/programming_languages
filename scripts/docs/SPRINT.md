...
| 4 | Esqueleto y tests | `glot prompt scaffold` (0.8.0) → [`scaffold-and-unit-tests.prompt.md`](../../.github/prompts/scaffold-and-unit-tests.prompt.md) · `glot new` (0.9.0) · `glot save` (0.9.0) | `chore(algorithms): add scaffold and tests for naive sort` | **agente** + script |
