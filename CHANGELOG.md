...
- `glot` v0.5.0: verbo `use`, que sitúa el trabajo del sprint (valida contra
  `.gitmodules`, crea el directorio del módulo, prepara y publica la rama
  `{tipo}/{fase}/{módulo}`, guarda el estado del sprint e imprime la ruta),
  con ensayo `-n/--dry-run` y 112 comprobaciones en el harness.
