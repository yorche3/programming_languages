...
public class NumbersIterativeTest {
    ...
    private NumbersIterative numbersIterative;

    @BeforeEach
    @SuppressWarnings("unused")
    void setUp() {
        System.out.println("Setting up NumbersRecursive for test...");
        this.numbersIterative = new NumbersIterative();
    }
    ...
    void testFibonacci() {
        ...
        int expected = 5;
        int actual = numbersIterative.fibonacci(5);
    ...
    void testFactorial() {
        ...
        int expected = 120;
        int actual = numbersIterative.factorial(5);
    ...
    void testSumNumbers() {
        ...
        int expected = 15;
        int actual = numbersIterative.sumNumbers(5);
